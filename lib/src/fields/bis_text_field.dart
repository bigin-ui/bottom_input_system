...
class BisTextField extends BisFormFieldDecoration<String> {
  ...
  @override
  BisFormFieldDecorationState<BisTextField, String> createState() =>
      _BisTextFieldState();
}

class _BisTextFieldState
    extends BisFormFieldDecorationState<BisTextField, String> {

...
class BisDropdown<T> extends BisFormFieldDecoration<T> {
  ...
  @override
  BisFormFieldDecorationState<BisDropdown<T>, T> createState() =>
      _BisDropdownState<T>();
}

class _BisDropdownState<T>
    extends BisFormFieldDecorationState<BisDropdown<T>, T> {
  @override
  void didUpdateWidget(covariant BisDropdown<T> oldWidget) {
